    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top shadow">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="d-flex">
            <input id="search-input" class="form-control me-2 rounded gray-900" type="search" placeholder="Search" aria-label="Search">
            <button onClick="searchNow()" class="btn btn-danger rounded" type="submit">GO</button>
            <script>
              function searchNow() {
